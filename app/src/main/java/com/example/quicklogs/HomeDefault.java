// to diplay the amount tab of the home page
...
// constructing the graph
  ...
  // when add an expense is clicked
    private void showExpenseAlert(String amount, String type, String desc) {
        ...
        final Button addBtnE = alertView.findViewById(R.id.alert_expense_add);
        final Button cancelBtnE = alertView.findViewById(R.id.alert_expense_cancel);

        final AlertDialog expenseDialog = builder.create();

        expenseDialog.setCanceledOnTouchOutside(true);
        expenseDialog.show();
        // add button of the expense dialog is clicked
        addBtnE.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    amount = Float.parseFloat(amountEntered.getText().toString());
        ...
        cancelBtnE.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                expenseDialog.dismiss();
            }
    ...
    private void showIncomeAlert() {
        ...
        final EditText DaSavings = alertView.findViewById(R.id.dasavings);
     ...
     // when add button of the income pop up is clicked
        addBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                float rdsavings = 0;
                try {
                    amount = Float.parseFloat(amountEntered.getText().toString().trim());
                    dasavings = Float.parseFloat(DaSavings.getText().toString().trim());
                    mdexpense = (amount - dasavings)/365;
                    rdsavings =   ((amount)/365)-mdexpense;
                ...
                if (amount<dasavings) {
                    Toast.makeText(getContext(),"The income should be more than desired savings",Toast.LENGTH_LONG).show();

                    amountEntered.setError("Amount value cannot be accepted");
                } else {
                    database.addIncome(amount, date,dasavings);
                    incomeDialog.dismiss();
                    Toast.makeText(getContext(),"The required daily savings is "+rdsavings+" and the maximum daily expense is "+mdexpense,Toast.LENGTH_LONG).show();
                }
            }
        });
